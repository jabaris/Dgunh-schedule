...
CREATE TABLE `education_program` (
  ...
  `education_level_id` int(4) DEFAULT NULL,
  `education_form_id` int(4) DEFAULT NULL,
  `education_profile_id` varchar(0) DEFAULT NULL,
  `education_program_name` varchar(255) DEFAULT NULL
...
INSERT INTO `education_program` VALUES (1,1,1,1,'Информационные системы в экономике');
